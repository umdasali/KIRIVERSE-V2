...
// import SideBarAdsCard from '../adsComponent/SideBarAdsCard'
...
async function getSocialEmbed(): Promise<{ items: { youtube: string, instagram: string }[] }> {
  const url =
    `https://cdn.contentful.com/spaces/${process.env.CONTENTFUL_SPACE_ID}` +
...
const { instagram, youtube } = items?.[0] as { youtube: string, instagram: string };
